...
```json
{
  "applicationName" : "weatherforecast app",
...
┃ ┃ ┃ Debug Adding symbol compilerSafeAppName with value 'weatherforecast app'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [Sample->weatherforecast app]
┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[0].sources[0].delegate.transformations[3] (RewritePath)
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Path 'Sample.csproj' matched 'Sample(.*)' with groups {g0=Sample.csproj, g1=.csproj} and was rewritten to 'weatherforecast app.csproj'
┃ ┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.sln' matched 'Sample(.*)' with groups {g0=Sample.sln, g1=.sln} and was rewritten to 'weatherforecast app.sln'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [Sample->weatherforecast app, sample-app->weatherforecast-stee...(truncated)]
